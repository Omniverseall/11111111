        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10 text-center md:text-left">
          ...
          <div className="md:mx-auto">
            ...
            <ul className="space-y-2">
              {navLinks.map(link => (
                <li key={link.href}>
                  <a href={link.href} className="hover:text-green-400 transition-colors text-sm">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div className="md:mx-auto">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href={`mailto:${dict.contactEmail}`} className="hover:text-green-400 transition-colors">{dict.contactEmail}</a></li>
              <li><a href={`tel:${dict.contactPhone.replace(/[\s-()]/g, '')}`} className="hover:text-green-400 transition-colors">{dict.contactPhone}</a></li>
