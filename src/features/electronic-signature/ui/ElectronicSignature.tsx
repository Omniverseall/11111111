...
export const ElectronicSignature: React.FC<{ dict: Dictionary }> = ({ dict }) => {
  const features = [
    { icon: <Shield className="w-5 h-5 text-tech-cyan" />, title: dict.eSignFeature1Title, desc: dict.eSignFeature1Desc },
    { icon: <FileCheck className="w-5 h-5 text-tech-teal" />, title: dict.eSignFeature2Title, desc: dict.eSignFeature2Desc },
    { icon: <Lock className="w-5 h-5 text-tech-cyan" />, title: dict.eSignFeature3Title, desc: dict.eSignFeature3Desc },
    ...
    <section id="solutions-section" className="section">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-base font-semibold text-tech-cyan uppercase tracking-wider mb-2">{dict.eSignSubtitle}</h3>
