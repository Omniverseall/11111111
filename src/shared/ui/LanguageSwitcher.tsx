          ...
          {languages.map((lang) => (
            <button
              ...
              className={`w-full flex items-center space-x-3 px-4 py-3 text-left 
                         hover:bg-tech-cyan/10 dark:hover:bg-tech-cyan/20 light:hover:bg-tech-cyan/10
                         transition-colors duration-150
                         ${language === lang.code ? 'bg-tech-cyan/20 dark:bg-tech-cyan/30 light:bg-tech-cyan/20' : ''}`}
            >
